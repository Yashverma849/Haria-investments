      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
        <div data-journey-cta className="mx-auto max-w-4xl p-8 text-center md:p-12">
          ...
          <p
            ...
            className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-cream/75 md:text-lg"
          >
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center rounded-full border border-cream/30 bg-cream/5 px-8 py-3.5 text-sm font-semibold text-cream backdrop-blur-sm transition-all hover:border-cream/50 hover:bg-cream/10"
            >
