...
import LegacyCarousel, { type TeamMember } from "@/components/legacy-carousel";
      ...
      <section className="py-20 md:py-28">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <AboutSectionHeading
            ...
            description="From insurance pioneers to modern wealth advisors, each generation has strengthened our commitment to protecting and growing client wealth."
          />

          <LegacyCarousel members={teamMembers} />
        </div>
      </section>
      ...
      <section className="border-y border-white/10 bg-surface/50 py-20 md:py-28">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <AboutSectionHeading
            ...
            description="With over six decades of combined expertise, we have guided clients through market cycles, economic changes, and evolving financial needs. From Insurance to Mutual Funds to now Equity, our diverse strengths help clients protect, grow, and diversify wealth."
